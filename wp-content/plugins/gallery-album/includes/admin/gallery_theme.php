	...
	private function display_table_list_theme(){
        ...
        <div class="wrap">
            <form method="post"  action="" id="admin_form" name="admin_form" ng-app="" ng-controller="customersController">
				<h2> <span>Gallery Themes</span> <a href="admin.php?page=wpdevart_gallery_themes&task=add_wpda_galltheme" class="add-new-h2">Add New</a><a target="blank" href="<?php echo wpdevart_gallery_support_url; ?>" class="wp_support">Support</a></h2>            
