			...
			"popup_general_settings"=>array(
				...
				"wpdeva_gall_popup_base_cornice"=>array(
					...
					"wpdeva_gall_video"=>array(
						"title"=>"Show all video as image too",
						"description"=>"Show all video as image too",
				...
				"params"=>array(
					...
					"wpdeva_gall_slide_show_effect_standart"=>array(
						...
						"values"=>array(
							...
							"5"=>"Opacity effect & From bottom to top",										
							"1"=>"From right to left",
							"6"=>"Opacity effect & From right to left",							
							"2"=>"From left to right",
							"7"=>"Opacity effect & From left to right",
							"4"=>"From top to bottom",														
							"8"=>"Opacity effect & From top to bottom",							
							"3"=>"Opacity effect",
							"9"=>"Add Scale effect for all effects"
						),
						"default_value"=>array("0"=>"0","1"=>"1","2"=>"2","3"=>"3","4"=>"4"),
...
/*############  Update gallery ID function  ################*/
	...
	private function display_table_list_popup_theme(){
        ...
        <div class="wrap">
			...
			<h2>Gallery Popup Themes <a href="admin.php?page=wpdevart_gallery_popup&task=add_wpda_galltheme" class="add-new-h2">Add New</a><a target="blank" href="<?php echo wpdevart_gallery_support_url; ?>" class="wp_support">Support</a></h2>            
