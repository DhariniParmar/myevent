	...
	private function page_view(){
        ...
        <div id="wpdevart_gallery_page_content">
			<div class="wpdevart_page_head">
    			<h2><span id="WpDevArt_Gallery_Page" title="Welcome to WpDevArt Gallery">WpDevArt Gallery Page </span>              
                    <a  dir="rtl" target="blank" href="<?php echo wpdevart_gallery_support_url; ?>" class="wp_support">Support</a>
                </h2>
            ...
            <div class="uploader_and_image_editor" id="uploader_and_image_editor">
           		<div id="wpda_gall_welcome_tab" class="tab active">
					<center>
                        ...
                        <li class="wpda_gall_descriptin" style="padding-left:10px;">Click on "Create gallery", then type the Gallery name and click on "Add new gallery" button on the right side.
                            The new gallery will be added to the tree.</li>
                        <li class="wpda_gall_descriptin">2.How to create Album:</li>
                        <li class="wpda_gall_descriptin" style="padding-left:10px;">Click the "+" button on the left side of created gallery, then you will see "Create Album" option. Click on "Create Album" and type the new Album name, then press "Create Album" button on the right side.
                            The new Album will be added to the tree.</li>
                        <li class="wpda_gall_descriptin">3.Uploading Images:</li>
                        <li class="wpda_gall_descriptin" style="padding-left:10px;">Click the "+" button on the left side of created Album. After that you will see "New" option. Click on "New" button and you will see the upload options in the right side. You can use the WpDevArt uploader for uploading new images or choose images from WordPress media library. Just choose(from WordPress media Library) or upload images(using Wpdevart Uploader) and click on Insert to album button from bottom. The uploaded images can be found in the Wpdevart library. You can select as many images as you need and then insert then into albums or delete them from albums or from Wpdevart library. If you want to edit the Album images, then click the "+" button on the left side of created Album and then click on image icon from left side. If you want to edit Album name or delete the Album, then click on the Album name.</li>	
                        <li class="wpda_gall_descriptin">4.Delete, Moving, Rearrange Images, Albums, Galleries using drag and drop feature.</li>									
                        <li class="wpda_gall_descriptin"><b style="margin-left:10px;">a. If you want to change image place, then drag the image(click on it and then move) and drop it on other image. Image place will be changed.</b></li>
           				<li class="wpda_gall_descriptin"><b style="margin-left:10px;">b. If you want to change Album place, then drag the Album(click on it and then move) and drop it on other Album. Album place will be changed.</b></li>
          			    <li class="wpda_gall_descriptin"><b style="margin-left:10px;">c. If you want to change Gallery place, then drag the Gallery(click on it and then move) and drop it on other Gallery. Gallery place will be changed.</b></li>                        
                        <li class="wpda_gall_descriptin"><b style="margin-left:10px;">d. If you want to move image from one Album to another, then drag the image and drop it on the other Album folder(icon).</b></li>
                        <li class="wpda_gall_descriptin"><b style="margin-left:10px;">e. If you want to delete the image, then drag it and drop it into basket(Recycle Bin).</b></li>
                        <li class="wpda_gall_descriptin"><b style="margin-left:10px;">f. If you want to move image to other Album editing tab, then drag image and drop into other Album editing tab(by this operation you will move image to other Album at the same time).</b></li> 
                        <li class="wpda_gall_descriptin"><b style="margin-left:10px;">g. You can change image places from editing tab by dragging and dropping them.</b></li>
                        <li class="wpda_gall_descriptin"><b style="margin-left:10px;">i. If you want to move image from editing tab to other Album, then drag image and drop into other Album folder(icon).</b></li>
                        <li class="wpda_gall_descriptin"><b style="margin-left:10px;">j. If you want to delete the image from editing tab, then drag it and drop it into basket(Recycle Bin).</b></li> 
                        <li class="wpda_gall_descriptin"><b style="margin-left:10px;">k. If you want to move all images from one Album to another Album editing tab, then drag the Album folder(icon) and drop into other Album editing tab.</b></li>
                        <li class="wpda_gall_descriptin"><b style="margin-left:10px;">l. If you want to delete the Album(with all images), then drag it and drop it into basket(Recycle Bin).</b></li>
  						<li class="wpda_gall_descriptin"><b style="margin-left:10px;">m. If you want to delete the Gallery(with all Albums and images), then drag it and drop it into basket.</b></li> 
                        <li class="wpda_gall_descriptin">5.Edit Galleries and Album names, Edit Image details, Removing Images.</b></li>
                        ...
                        <li class="wpda_gall_descriptin"><b style="margin-left:10px;"></b>b.Click on the album of tree and in the album editing tab you can edit the images of this album.</li>
                        <li class="wpda_gall_descriptin"><b style="margin-left:10px;"></b>c.Click on the image of tree and in the image editing tab you can edit this image.</li>                     
					</ol>
                </div>
						...
						<div class="standart_uploader active">
                       		<form id="wpdevart_standart_uploader" action="" method="post" enctype="multipart/form-data">
                                ...
                                <div style="display:inline-block;padding:5px;border:solid rgb(153, 153, 153) 2px;margin-left:15px;margin-top:15px;">
                                    ...
                                    <input name="insert_from_youtube_url" type="submit"  style="right:200px;" value="Insert to album">
						...
						<div class="show_image_conteiner">
                   		...
                   		<div class="image_info_conteiner">
                            ...
                            <div id="rot_right_left">
                                <input id="rot_right" name="right" type="submit" class="button button-primary wpda_gall_isnert_from_media" value="&#8635;" style=" font-size: 20px;" title="rotate right">
                                <input id="rot_left" name="left" type="submit" class="button button-primary wpda_gall_isnert_from_media" value="&#8634;" style=" font-size: 20px;" title="rotate left">
                            </div>
			...
			if(isset($_POST['wpda_gall_gallery_page_nonce_name']) && wp_verify_nonce($_POST['wpda_gall_gallery_page_nonce_name'],'wpda_gall_gallery_page_nonce_action') ){	
				if(isset($_POST['medi_library_attachment'])) {
					if(isset($_POST['gallery_name']) && $_POST['gallery_name'] && isset($_POST['album_name']) && $_POST['album_name']){
						...
						if((integer) wpdevart_gallery_start_mem < 1024){ini_set('memory_limit', '1024M');}                                               //01-11-2017						
...
/////////////////////////////////////////////////////////////  21-01-2018
	public function insert_from_standart_uploader_ajax($files,$gallery_name,$album_name){
		...
		if(!empty($files["name"])){	  
			if((integer) wpdevart_gallery_start_mem < 1024){ini_set('memory_limit', '1024M');}                                         
			$echo='';
	...
	public function remove_crop_image_from_url($file_name){   
		foreach($this->directorys as $value){
			if($value != $this->directorys['original'] && $file_name != ''){unlink($value.$file_name);}
		}
	}	
